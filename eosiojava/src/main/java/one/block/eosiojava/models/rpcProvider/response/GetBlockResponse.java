...
public class GetBlockResponse {
    ...
    /**
     * The Block number. Which is used to construct refBlockNum of {@link one.block.eosiojava.models.rpcProvider.Transaction}
     */
    @SerializedName("block_num")
    private BigInteger  blockNum;

    /**
     * The Reference block prefix. Which is used to construct refBlockPrefix of {@link one.block.eosiojava.models.rpcProvider.Transaction}
     */
    @SerializedName("ref_block_prefix")
    private BigInteger  refBlockPrefix;

    /**
     * Gets the Timestamp of backend
     * <br>
     *      Format: Date/time string in the format YYYY-MM-DDTHH:MM:SS.sss.
     *
    ...
    /**
     * Gets block number. Which is used to construct refBlockNum field of {@link one.block.eosiojava.models.rpcProvider.Transaction}
     *
    ...
    /**
     * Gets ref block prefix. Which is used for refBlockPrefix field of {@link one.block.eosiojava.models.rpcProvider.Transaction}
     *
