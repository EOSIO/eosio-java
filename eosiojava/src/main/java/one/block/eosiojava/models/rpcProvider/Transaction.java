...
public class Transaction implements Serializable {
    ...
    /**
     * The Expiration which will be calculated if the value is not set. It is based on {@link
    ...
    /**
     * The Ref block num which will be calculated if the value is not set. It is based on {@link
     ...
     * <br>
     * It is calculated if the value is not set. Its value get assigned from {@link
