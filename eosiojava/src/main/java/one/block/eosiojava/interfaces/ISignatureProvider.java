...
public interface ISignatureProvider {
     ...
     * <br/> Check signTransaction flow() in "complete
    ...
    EosioTransactionSignatureResponse signTransaction(
            EosioTransactionSignatureRequest eosioTransactionSignatureRequest) throws SignTransactionError;

    /**
     * Gets available keys from signature provider
     * <br/>
     * Check createSignatureRequest() flow in "complete workflow" for more detail of
     * how the method is used
     *
     * @return the available keys of signature provider in EOS format
     * @throws GetAvailableKeysError
     */
