...
public class TransactionProcessorTest {
    ...
    public void prepare() {
        ...
        this.mockRPC(
                ...
                Utils.getDefaultGson().fromJson(mockedGetBlockResponse, GetBlockResponse.class),
                null, null);
    ...
    public void isAllowTransactionToBeModified() {
        this.mockRPC(
                Utils.getDefaultGson().fromJson(mockedGetInfoResponse, GetInfoResponse.class),
                Utils.getDefaultGson().fromJson(mockedGetBlockResponse, GetBlockResponse.class),
                Utils.getDefaultGson().fromJson(mockedGetRequiredKeysResponse, GetRequiredKeysResponse.class),
                Utils.getDefaultGson().fromJson(MOCKED_PUSHTRANSACTION_RESPONE_JSON, PushTransactionResponse.class));
    ...
    private void mockDefaultSuccessData() {
        ...
        this.mockSerializationProvider(MOCKED_ACTION_HEX, MOCKED_TRANSACTION_HEX, mockedDeserilizedTransaction);
        this.mockSignatureProvider(Arrays.asList("Key1", "Key2"),
                Utils.getDefaultGson().fromJson(mockedEosioTransactionSignatureResponseJSON, EosioTransactionSignatureResponse.class));
    }
